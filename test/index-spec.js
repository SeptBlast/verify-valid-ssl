...
const {
    ...
    validWildCardCert,
    validWildCardKey,
} = require("./__fixtures__/validate-ssl");
...
describe("Validation", () => {
    describe("#isValid functions should return false", () => {
        ...
        it("should validate with wildcard cert", async () => {
            (
                await Validation.isValidSSL(validWildCardCert, { key: validWildCardKey, domain: "m.xxx.com", skipDateValidation: false })
            ).should.be.true();
            (
                await Validation.isValidSSL(validWildCardCert, { key: validWildCardKey, domain: "xxx.com", skipDateValidation: false })
            ).should.be.false();
            (
                await Validation.isValidSSL(validWildCardCert, { key: validWildCardKey, domain: ".xxx.com", skipDateValidation: false })
            ).should.be.false();
            (
                await Validation.isValidSSL(validWildCardCert, { key: validWildCardKey, domain: "foo.bar.xxx.com", skipDateValidation: false })
            ).should.be.false();
            (
                await Validation.isValidSSL(validWildCardCert, { key: validWildCardKey, domain: "foobar.xxx.com", skipDateValidation: false })
            ).should.be.true();
            (
                await Validation.isValidSSL(validWildCardCert, { key: validWildCardKey, domain: "-foo.xxx.com", skipDateValidation: false })
            ).should.be.false();
            (
                await Validation.isValidSSL(validWildCardCert, { key: validWildCardKey, domain: "-foo-.xxx.com", skipDateValidation: false })
            ).should.be.false();
    ...
    describe("Validation", () => {
        ...
        it("#validateSSLKey", async () => {
            ...
            result.should.deepEqual({
                modulus:
                    "",
            });
        });
